...
import { sortHand } from "../game/tiles.js";
...
export default function PlayerHand({
  ...
  const displayHand = sortHand(player.hand, sortMode);
  return (
    <div
      style={{
        ...styles.wrap,
      ...
      <div style={styles.header}>
        ...
        <div style={{ display: "flex", gap: "6px", alignItems: "center" }}>
          ...
          {player.hasInitialMeld && (
            <span style={styles.meldBadge}>✓ melded</span>
          )}
        </div>
      </div>
      ...
      <div style={styles.tilesWrap}>
        {displayHand.map((tile) => (
          <Tile
            ...
            onClick={
              isActive && onTileClick && !player.isAI
                ? () => onTileClick(tile.id)
                : undefined
            }
            faceDown={hideHand}
